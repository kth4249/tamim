...
class _CalendarPageState extends State<CalendarPage> {
  ...
  List _getEventsForDay(DateTime day) {
    ...
    Map<String, dynamic> events = context.read<EventsProvider>().events;
    return events[dayT] ?? [];
  }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          if (key['iconIndex'] == 1) {
                            return Container(
                              ...
                              // ),
                              child: Icon(
                                IconData(12345, fontFamily: "MaterialIcons"),
                                color: Colors.green,
                              ),
                            );
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (event_icon_index['iconIndex'] == 1) {
                        return Container(
                          ...
                          child: ListTile(
                            onLongPress: () {
                              context.read<EventsProvider>().deleteEvents(
                                _selectedDay,
                                index,
                              );
                              saveData();
                              ...
                              showDialog(
                                ...
                                builder:
                                    (BuildContext context) => AlertDialog(
                                      ...
                                      title: Text('Null'),
                                      content: Text('일정 내용을 추가하지 않았습니다.'),
                                      actions: <Widget>[
                                        TextButton(
                                          onPressed:
                            ...
                            showDialog(
                              ...
                              builder:
                                  (BuildContext context) => AlertDialog(
                                    ...
                                    title: Text('Null'),
                                    content: Text('마커를 지정하지 않았습니다 마커를 지정해주세요.'),
                                    actions: <Widget>[
                                      TextButton(
