...
mixin _$ParishGroup {
  ...
  $ParishGroupCopyWith<ParishGroup> get copyWith =>
      _$ParishGroupCopyWithImpl<ParishGroup>(this as ParishGroup, _$identity);
...
abstract mixin class $ParishGroupCopyWith<$Res> {
  factory $ParishGroupCopyWith(
          ParishGroup value, $Res Function(ParishGroup) _then) =
      _$ParishGroupCopyWithImpl;
  @useResult
  $Res call(
      {int id,
      int parishId,
...
/// @nodoc
class _$ParishGroupCopyWithImpl<$Res> implements $ParishGroupCopyWith<$Res> {
...
class _ParishGroup implements ParishGroup {
  ...
  factory _ParishGroup.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParishGroupCopyWith<_ParishGroup> get copyWith =>
      __$ParishGroupCopyWithImpl<_ParishGroup>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ParishGroupToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ParishGroupCopyWith<$Res>
    implements $ParishGroupCopyWith<$Res> {
  factory _$ParishGroupCopyWith(
          _ParishGroup value, $Res Function(_ParishGroup) _then) =
      __$ParishGroupCopyWithImpl;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$ParishGroupCopyWithImpl<$Res> implements _$ParishGroupCopyWith<$Res> {
